...
class ActivityStatusStore {
  ...
  update(
    ...
    ttlMs: number = DEFAULT_ACTIVITY_TTL_MS
...
declare global {
  var __justinActivityStatusStore: ActivityStatusStore | undefined;
}

export const activityStatusStore =
  globalThis.__justinActivityStatusStore ??
  (globalThis.__justinActivityStatusStore = new ActivityStatusStore());
